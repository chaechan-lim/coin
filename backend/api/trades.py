...
def _order_to_response(o: Order) -> OrderResponse:
    ...
    return OrderResponse(
        ...
        status=o.status,
        requested_price=o.requested_price or o.executed_price or 0.0,
        executed_price=o.executed_price or 0.0,
        requested_quantity=o.requested_quantity or o.executed_quantity or 0.0,
        executed_quantity=o.executed_quantity or 0.0,
        fee=o.fee or 0.0,
        is_paper=o.is_paper,
